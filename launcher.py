...
class xnat_pic_gui():
    ...
    class metadata():
        ...
        def frame_metadata(self, master): 
            ...
            # Frame Title
            self.frame_title = ttk.Label(master.frame, text="XNAT-PIC Project Data", style='Title.TLabel')
            self.frame_title.place(relx=0.6, rely=0.05, anchor=tk.CENTER)
            #################### Menu ###########################
            ...
            self.label_frame_ID = ttk.LabelFrame(master.frame, text="ID")
            #
